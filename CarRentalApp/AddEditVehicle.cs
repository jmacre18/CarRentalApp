...
namespace CarRentalApp
{
    public partial class AddEditVehicle : Form
    {
        ...
        public AddEditVehicle(ManageVehicleListing manageVehicleListing = null) //=null makes it not required
        {
            InitializeComponent();
            titleLabel.Text = "Add New Vehicle";
